...
const Footer = () => {
    ...
    return (
        <>
            <div className='container flex justify-center items-center text-white font-bold'>
                <p>Contact me: </p>
                <motion.div variants={variants} initial='hidden' whileInView='show' transition={{ duration: 2 }} className="footer-card w-auto">
                    {/* <motion.a variants={children} className="socialContainer containerOne" href="#">
                    ...
                    <motion.a variants={children} className="socialContainer containerTwo" href="https://twitter.com/adegbitejoshuaa">
                    ...
                    <motion.a variants={children} className="socialContainer containerThree" href="https://linkedin.com/in/adegbite-joshua-8a45a6257/">
                    ...
                    <motion.a variants={children} className="socialContainer containerFour" href="https://wa.link/7ttoiw">
                    ...
                    <motion.a variants={children} className="socialContainer containerFive" href="https://github.com/Adegbite-Joshua">
                        <img className='socialSvg' src='github.png'/>
                    </motion.a>
                    
                    <motion.a variants={children} className="" href="tel:+2347015886456">
