...
const Footer = () => {
    ...
    return (
        <>
            <p className='md:hidden text-white text-center'>Contact me: </p>
            <div className='container flex justify-center items-center text-white font-bold text-sm sm:text-lg'>
                ...
                <motion.div variants={variants} initial='hidden' whileInView='show' transition={{ duration: 2 }} className="footer-card w-auto">
                    ...
                    <motion.a variants={children} target='blank' className="socialContainer containerTwo" href="https://twitter.com/adegbitejoshuaa">
                    ...
                    <motion.a variants={children} target='blank' className="socialContainer containerThree" href="https://linkedin.com/in/adegbite-joshua-8a45a6257/">
                    ...
                    <motion.a variants={children} target='blank' className="socialContainer containerFour" href="https://wa.link/7ttoiw">
