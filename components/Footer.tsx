    ...
    return (
        <>
            <div className='container flex justify-center items-center text-white font-bold'>
                <p>Contact me: </p>
                <motion.div variants={variants} initial='hidden' whileInView='show' transition={{ duration: 2 }} className="footer-card">
                    ...
                    <motion.a variants={children} className="socialContainer containerTwo" href="#">
                    ...
                    <motion.a variants={children} className="socialContainer containerThree" href="#">
                    ...
                    <motion.a variants={children} className="socialContainer containerFour" href="#">
