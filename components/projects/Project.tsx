...
const Project = ({ siteUrl, gitHubUrl, imageUrl, title }: { siteUrl: string, gitHubUrl: string, imageUrl: string, title: string }) => {
    const variants = {
        hidden: {
            opacity: 0,
            x: -100
    ...
    return (
        <motion.div variants={variants} whileInView='show' className="project-card overflow-hidden mx-auto my-4">
            ...
            <div className="project-card__descr-wrapper h-2/6">
                ...
                <div className="project-card__links mb-2">
                    <a className="bg-gray-400 px-4 rounded-xl duration-500" target='blank' href={siteUrl}>
                        ...
                        <p className="project-link">Preview</p>
                    </a>
                    <a className='bg-gray-400 px-4 rounded-xl duration-500' href={gitHubUrl}>
                        ...
                        <p className="project-link">Code</p>
                    </a>
                </div>
            </div>
        </motion.div>
